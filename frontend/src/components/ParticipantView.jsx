...
import MicOffSmallIcon from "../icons/MicOffSmallIcon.jsx";
...
export const CornerDisplayName = ({
  ...
  return (
    <>
      ...
      {(webcamStream || micStream || screenShareStream) && (
        <div className="top-2 right-2 absolute rounded-md  p-2 cursor-pointer ">
          <div
            onClick={(e) => {
              e.stopPropagation();
            }}
                      ...
                      {ReactDOM.createPortal(
                        ...
                        >
                          <div
                            ...
                            className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-gray-800 "
                          >
                            <div
...
export function ParticipantView({ participantId }) {
  ...
  return mode === "CONFERENCE" ? (
    <div
      ...
      className={`relative overflow-hidden rounded-xl video-cover bg-gray-800 h-full w-full max-h-[600px] flex items-center justify-center border-4 border-gray-700`}
    >
      ...
      {webcamOn ? (
        ...
        <div className="rounded-2xl" style={{backgroundColor: "rgba(85,104,254,255)"}} >
