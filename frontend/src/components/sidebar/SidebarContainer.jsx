...
const SideBarTabView = ({
  ...
  return (
    <div
      className=" border-l border-gray-700 border-l-[4px]"
      style={{
        height,
        ...
        backgroundColor: "rgba(6,10,19,255)",
      }}
    >
      <div>
        <div
          ...
          >
            <div className="fixed inset-0 overflow-y-hidden" >
              <div className="flex h-screen items-center justify-center text-center">
                <Dialog.Panel className="w-screen transform overflow-hidden shadow-xl transition-all" style={{backgroundColor: "rgb(8,12,20)"}}>
                  <SideBarTabView
                    height={"100%"}
