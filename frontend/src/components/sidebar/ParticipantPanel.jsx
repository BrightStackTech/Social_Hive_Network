...
function ParticipantListItem({ participantId, raisedHand }) {
  ...
  return (
    <div className="mt-2 m-2 p-2 bg-gray-800 rounded-lg mb-0">
      <div className="flex flex-1 items-center justify-center relative">
        <div
          style={{
            color: "white",
            backgroundColor: "rgba(85,104,254,255)",
          }}
          className="h-10 w-10 text-lg mt-0 rounded-lg font-semibold overflow-hidden flex relative items-center justify-center"
        >
