  ...
  return (
    ...
    >
      <div
        ...
        } flex-col py-1 px-2 rounded-md bg-gray-800`}
      >
        <p style={{ color: "rgba(85,104,254,255)" }}>
  ...
  return (
    ...
    >
      <div class="relative  w-full">
        ...
        <input
          type="text"
          className="py-4 text-white border-gray-600 border-[3px] rounded-2xl pr-10 pl-2 focus:outline-none w-full bg-gray-900"
